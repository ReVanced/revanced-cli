...
internal object Constants {
    ...
    // utility commands
    private val COMMAND_CHMOD = if (Adb.usingSuperSU) "chmod 700" else "chmod +x"
    ...
    // mount script paths
    internal val PATH_MOUNT = if (Adb.usingSuperSU) "/su/su.d/$NAME_MOUNT_SCRIPT" else "/data/adb/service.d/$NAME_MOUNT_SCRIPT"
