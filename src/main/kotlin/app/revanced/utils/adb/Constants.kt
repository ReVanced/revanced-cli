...
internal object Constants {
    ...
    // utility commands
    private val COMMAND_CHMOD = if (Adb.SuperSU) "chmod 700" else "chmod +x"
    ...
    // mount script paths
    internal val PATH_MOUNT = if (Adb.SuperSU) "/su/su.d/$NAME_MOUNT_SCRIPT" else "/data/adb/service.d/$NAME_MOUNT_SCRIPT"
